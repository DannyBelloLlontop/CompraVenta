...
<head>
    <meta charset="utf-8" />
    <title>Epps Proveedores | Acceso</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 auth-one-bg h-100">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <!-- TODO:Aqui Empieza DIV para modificar LOGOTIPO -->
                                            <div class="mb-4">
                                                <a href="index.html" class="d-block">
                                                    <img src="assets/images/logo-light.png" alt="" height="18">
                                                </a>
                                            </div>
                                            <!-- TODO: Aqui termina DIV para modificar LOGOTIPO -->
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Acceder al Sistema de Compra y Venta de Epps Proveedores.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form action="" method="post" id="login_form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="usu_correo" id="usu_correo" placeholder="Ingrese su correo electronico">
                                                </div>
